...
export class PersonalizationController {
  ...
  createPersonalization = catchAsync(
    async (
      ...
      const result = await this.personalizationService.createPersonalization(
        req.body,
      );
  ...
  uploadPersonalizationImage = catchAsync(
    async (
      req: Request<{}, {}, UploadPersonalizationImageInput>,
      res: Response,
    ): Promise<void> => {
      const result =
        await this.personalizationService.uploadPersonalizationImage(req.body);
  ...
  selectPersonalizationJokes = catchAsync(
    async (
      req: Request<{}, {}, SelectPersonalizationJokesInput>,
      res: Response,
    ): Promise<void> => {
      const result =
        await this.personalizationService.selectPersonalizationJokes(req.body);
